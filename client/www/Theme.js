    ...
    Theme = (function() {
      ...
      Theme.prototype.load = function(callback) {
        ...
        return $.getJSON("/img/themes/" + this.themeName + "/settings.json", function(data) {
          ...
          if (that.isHighDpiAvailable(that.settings.sheet)) that.highDpiTheme = true;
          return callback();
        });
      };
      ...
      Theme.prototype.getSpriteSheetUrl = function() {
        return ("/img/themes/" + this.themeName + "/") +
          (this.isRenderInHighDpi() ? this.settings.sheet.highDpiFilename : this.settings.sheet.filename);
      };
      ...
      Theme.prototype.getSheetCoordinate = function(coord) {
          return this.isRenderInHighDpi() ? coord * 2 : coord;
      };
